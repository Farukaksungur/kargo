...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('markalar.show', $marka->id) }}" class="btn btn-secondary">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <p class="mb-0 font-weight-bold">{{ $marka->ad }}</p>
                        </div>
                        <div class="col-md-4 mb-3">
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                    <a href="{{ route('markalar.show', $marka->id) }}" class="btn btn-primary btn-block mb-2">
                        <i class="fas fa-tag mr-2"></i>Marka Detayına Dön
                    </a>
